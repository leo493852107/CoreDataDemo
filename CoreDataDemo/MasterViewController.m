...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSFetchedResultsController *fetchedReusltsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:@"name" cacheName:@"Master"];
    fetchedReusltsController.delegate = self;
    self.fetchedResultsController = fetchedReusltsController;
